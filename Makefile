...
release: run-cmake-release
	...
	cp -f ./OpenFPGA_RS/vpr/vpr build/bin/vpr
...
debug: run-cmake-debug
	...
	cp -f ./yosys_verific_rs/yosys/install/bin/yosys dbuild/bin/yosys
	cp -f ./yosys_verific_rs/yosys/install/bin/abc dbuild/bin/abc
	cp -f ./yosys_verific_rs/yosys/install/bin/de dbuild/bin/de
	cp -f ./OpenFPGA_RS/vpr/vpr dbuild/bin/vpr
