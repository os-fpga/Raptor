...
define_param -block PLL -name pll_POSTDIV2		-addr  64 -width 3 -type int
define_param -block PLL -name pll_POSTDIV1		-addr  61 -width 3 -type int
define_attr -block PLL -name pll_PLLEN			-addr  60 -width 1 -enum {PLLEN_0 0} {PLLEN_1 1} -enumname PLL_ATT_8
define_param -block PLL -name pll_REFDIV		-addr  54 -width 6 -type int -enumname PLL_ATT_7
define_param -block PLL -name pll_FBDIV			-addr  42 -width 12 -type int -enumname PLL_ATT_6
define_param -block PLL -name pll_FRAC			-addr  18 -width 24 -type int -enumname PLL_ATT_5
...
define_param -block PLL -name pll_DSKEWCALCNT	        -addr  13 -width 3 -type int
define_param -block PLL -name pll_DSKEWCALIN	        -addr   1 -width 12 -type int
