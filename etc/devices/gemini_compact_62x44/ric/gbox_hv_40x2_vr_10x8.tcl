...
####################################
define_block -name GBOX_HV_40X2_VR_10X8
...
# ROOT_BANK_CLKMUX
###############################################################################
create_instance -block ROOT_BANK_CLKMUX -name u_gbox_root_bank_clkmux_hv_1 -logic_address [expr ${IO_CHAIN_GBOX_ROOT_BANK_MUX_START} + 20] -parent GBOX_HV_40X2_VR_10X8
create_instance -block ROOT_BANK_CLKMUX -name u_gbox_root_bank_clkmux_hv_0 -logic_address [expr ${IO_CHAIN_GBOX_ROOT_BANK_MUX_START}  ] -parent GBOX_HV_40X2_VR_10X8
###############################################################################
# VCO_FAST (FCLK_MUX)
###############################################################################
create_instance -block FCLK_MUX -name u_gbox_fclk_mux_hv_all -logic_address [expr ${IO_CHAIN_GBOX_VCO_FAST_START}] -parent GBOX_HV_40X2_VR_10X8
###############################################################################
# HV_PGEN
###############################################################################
create_instance -block HV_PGEN -name u_HV_PGEN_dummy -logic_address [expr ${IO_CHAIN_GBOX_HV_PGEN_START}] -parent GBOX_HV_40X2_VR_10X8
...
define_ports -block GBOX_HV_40X2_VR_10X8 -in system_reset_n 
define_ports -block GBOX_HV_40X2_VR_10X8 -in cfg_done 
##
define_ports -block GBOX_HV_40X2_VR_10X8 -out hv_0_root_core_clk_bit1 hv_0_root_core_clk_bit0 
define_ports -block GBOX_HV_40X2_VR_10X8 -out hv_1_root_core_clk_bit1 hv_1_root_core_clk_bit0 
define_ports -block GBOX_HV_40X2_VR_10X8 -out hv_0_root_cdr_clk_bit1 hv_0_root_cdr_clk_bit0 
define_ports -block GBOX_HV_40X2_VR_10X8 -out hv_1_root_cdr_clk_bit1 hv_1_root_cdr_clk_bit0 
#####
define_ports -block GBOX_HV_40X2_VR_10X8 -out hv_rx_io_clk0_bit1 hv_rx_io_clk0_bit0 
define_ports -block GBOX_HV_40X2_VR_10X8 -out hv_rx_io_clk1_bit1 hv_rx_io_clk1_bit0 
#####
for {set tt 2} {$tt <= 8} {incr tt} { 
  for {set run_idx 0} {$run_idx <= 48} {incr run_idx} { 
      define_ports -block GBOX_HV_40X2_VR_10X8 -in left_${tt}_f2a_bit${run_idx}
...
for {set tt 2} {$tt <= 8} {incr tt} { 
  for {set run_idx 0} {$run_idx <= 23} {incr run_idx} { 
      define_ports -block GBOX_HV_40X2_VR_10X8 -out left_${tt}_a2f_bit${run_idx}
 } 
} 
#####
