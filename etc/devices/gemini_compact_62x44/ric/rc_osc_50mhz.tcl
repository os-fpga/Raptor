...
####################################
define_param -block RC_OSC_50MHZ -name cfg_bank_osc_cal		-addr 9 -width 6 -type int
define_param -block RC_OSC_50MHZ -name cfg_bank_osc_ib_cop	-addr 7 -width 2 -type int
...
define_param -block RC_OSC_50MHZ -name cfg_bank_osc_bgr		-addr 3 -width 3 -type int
define_param -block RC_OSC_50MHZ -name cfg_bank_osc_rsv		-addr 0 -width 3 -type int
####################################
